...
_C.MODEL.N_HEAD = 2
_C.MODEL.N_LAYER = 4
_C.MODEL.EMBD_PDROP = 0.1
_C.MODEL.ATTN_PDROP = 0.1
_C.MODEL.RESID_PDROP = 0.1
_C.MODEL.AFN = 'gelu'
_C.MODEL.CLF_PDROP = 0.1
_C.MODEL.TOPK = 20
_C.MODEL.LANDMARK = 10
...
# Whether test nformer or encoder only
_C.TEST.TEST_NFORMER = 'yes'

# Data type durining test
...
_C.MODEL.BACKBONE_WEIGHTS_PATH = ""  # Path to the pre-trained backbone weights
