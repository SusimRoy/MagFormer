...
class nformer_model(nn.Module):
    def __init__(self, cfg, num_classes):
        ...
        self.backbone = Baseline(cfg, num_classes, cfg.MODEL.LAST_STRIDE, cfg.MODEL.PRETRAIN_PATH, cfg.MODEL.NECK, cfg.TEST.NECK_FEAT, cfg.MODEL.NAME, cfg.MODEL.PRETRAIN_CHOICE)
